...
const VerifyEmailPage = () => {
  ...
  return (
    <div className="relative min-h-screen flex justify-center items-center px-6">
      {/* Nút Log Out ở góc trái trên cùng */}
      <button
        onClick={handleLogout}
        className="absolute top-4 left-4 text-red-600 font-semibold hover:underline"
      >
        Log Out
      </button>
      ...
      <div className="flex mx-[16%]">
        ...
        <div className="bg-white p-12 w-[500px] lg:w-[600px] text-center">
          ...
          <div className="text-gray-600 mt-6">
            ...
            {timer > 0 ? (
              <span className="font-bold text-gray-500"> Resend in {timer} sec</span>
            ) : (
              <button
