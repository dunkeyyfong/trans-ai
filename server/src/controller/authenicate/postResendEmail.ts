...
export const postResendEmail = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    const tokenVerify = user.verifyToken
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <a href="${process.env.URL_AUTHENICATE}/email-verified?t=${user.verifyToken}" class="btn">Verify My Email</a>
